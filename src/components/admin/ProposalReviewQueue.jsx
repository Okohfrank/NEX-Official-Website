...
import { Award, CheckCircle2, RefreshCw, Star, Send } from 'lucide-react';
    ...
    <div className="space-y-6 animate-in fade-in w-full">
      <div className="p-6 sm:p-8 bg-white border border-slate-200/90 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-600 font-medium">Perform 5-axis technical review scoring and assign decision states saved directly to Supabase.</p>
        </div>
